...
class TSL_Admin {
    ...
    public function tsl_save_config() {
        ...
        $all_data = [
            "tsl_form_template"        => sanitize_text_field($data['tsl_form_template']),
            "tsl_form_image"           => esc_url($data['tsl_form_image']),
            "tsl_logout_option"        => sanitize_text_field($data['tsl_logout_option']),
            "tsl_logout_option"        => sanitize_text_field($data['tsl_logout_option']),
            ...
            "tsl_recaptcha_site_key"   => sanitize_text_field($data['tsl_recaptcha_site_key']),
            "tsl_recaptcha_secret_key" => sanitize_text_field($data['tsl_recaptcha_secret_key']),
